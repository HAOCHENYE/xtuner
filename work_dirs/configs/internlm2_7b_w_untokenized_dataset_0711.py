...
from xtuner.dataset.intern_repo_streaming import (
    ROLE_CFG_CHAT, build_internlm_streaming_dataset)
from xtuner.dataset.samplers import InternRepoSampler
from xtuner.engine import (DatasetInfoHook, EvaluateChatHook,
                           SamplerLevelIterTimerHook, ThroughputHook,
                           VarlenAttnArgsToMessageHubHook)
from xtuner.engine.hooks import HFCheckpointHook
from xtuner.engine.runner.loops import IterableEpochBasedTrainLoop
...
train_cfg = dict(type=IterableEpochBasedTrainLoop, max_epochs=max_epochs)
...
work_dir = "/mnt/petrelfs/yehaochen/codebase/xtuner/work_dirs/internlm2_7b_w_untokenized_dataset_try_0711"
