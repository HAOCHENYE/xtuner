...
#######################################################################
# Model
pretrained_model_name_or_path = "/mnt/hwfile/mm_dev/sft/model_releases/S_Ampere_7B_v1_1_enchance_FT_v1_0_0_s1_rc47_1970_hf"
use_varlen_attn = True

# Data
dataset_folder = "/mnt/hwfile/mm_dev/yehaochen/datasets/internlm2.5_s2_0621_rc4/training/chatml_llamav13_32k_merged/train"  # noqa: E501
...
custom_hooks = [
    dict(
        type=DatasetInfoHook, tokenizer=tokenizer, is_intern_repo_dataset=True
    ),
    dict(
...
work_dir = "/mnt/hwfile/mm_dev/yehaochen/ckpts/7B/ampere/20240702"
