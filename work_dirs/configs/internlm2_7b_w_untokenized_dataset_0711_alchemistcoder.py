...
from xtuner.dataset.intern_repo_streaming import ROLE_CFG_CHAT, build_internlm_streaming_dataset
...
# Data
dataset_folder = (
    "/mnt/hwfile/mm_dev/yehaochen/datasets/internlm2.5_s2_0621_rc4/alchemistcoder_v4x_r63_en/"  # noqa: E501
)
...
train_cfg = dict(type=TrainLoop, max_iters=5)
...
work_dir = "/mnt/petrelfs/yehaochen/codebase/xtuner/work_dirs/internlm2_7b_w_untokenized_dataset_0711_alchemistcoder"
